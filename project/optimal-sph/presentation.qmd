...
- System State $\vec{x}_1,\dots,\vec{x}_N$ and $\vec{v}_1,\dots,\vec{v}_N$
- Constants: $\vec{g}, m, \nu, N$
...
<div data-id="drho-dt">
$\left\langle\rho_i\right\rangle 
+ \Delta t \left\langle \frac{D\rho_i}{Dt} \right\rangle
= \rho_0$
</div> 
:::
...
<span class="comment">$\rho_i^*:=$</span></span>
<span>$+ \underbrace{\Delta t^2 \langle \nabla^2 p_i \rangle}_{\Delta \rho_i^{p}}$</span>
<span>$= \rho_0$</span> 
</div> 
